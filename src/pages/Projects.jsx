    ...
    <div id="projects" className="projects">
      <div className="projects-content">
        <div className="menu">
          ...
          <button className={`menu-btn ${category === 'videoGames' ? 'active' : ''}`} type="button" value="videoGames" onClick={handleClickCategory}>Video Games</button>
          <button className={`menu-btn ${category === '3d' ? 'active' : ''}`} type="button" value="3d" onClick={handleClickCategory}>3D Design</button>
        </div>
